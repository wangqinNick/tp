...
&nbsp;&nbsp;&nbsp;&nbsp;[3.7 [Proposed] Notes Feature](#37-proposed-notes-feature) <br>
...
**Do note that `undo` will only undo the last command that edited the data files, namely commands with a `PromptType` of `EDIT`. Hence, this refers to the addition and deletion of Tasks, Modules and Lessons**
1. Undo:
