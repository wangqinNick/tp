...
#### Features
* **Done Feature**: Added the ability to mark a task as done in ra.VI. ([\#38](https://github.com/AY2021S1-CS2113T-T09-2/tp/pull/38))
...
* **List Feature**: Added the ability to list all added tasks and modules in ra.VI. ([\#38](https://github.com/AY2021S1-CS2113T-T09-2/tp/pull/38))
...
* **Help Feature**: Added the ability to view the list of all available commands, and help messages for each command. ([\#39](https://github.com/AY2021S1-CS2113T-T09-2/tp/pull/39), [\#107](https://github.com/AY2021S1-CS2113T-T09-2/tp/pull/107))
...
* **Summary Feature**: Added the ability to view a task summary in collaboration with [Jun You](https://github.com/AY2021S1-CS2113T-T09-2/tp/tree/master/docs/team/f0fz.md). ([\#93](https://github.com/AY2021S1-CS2113T-T09-2/tp/pull/93))
...
* **View Timetable Feature**: Added the ability to view the timetable for the day or week in collaboration with [Sean Lim](https://github.com/AY2021S1-CS2113T-T09-2/tp/tree/master/docs/team/aseanseen.md). ([\#120](https://github.com/AY2021S1-CS2113T-T09-2/tp/pull/120))
...
* **Reset Timetable Feature**: Added the ability to reset the timetable. ([\#230](https://github.com/AY2021S1-CS2113T-T09-2/tp/pull/230))
...
#### Documentation
  ...
  * Developer Guide:
    ...
    * Added user stories for existing features and manual testing steps for `list`, `help`, and `summary` commands. [\#251](https://github.com/AY2021S1-CS2113T-T09-2/tp/pull/251)
...
#### Enhancements to existing features
  * Wrote additional tests for `help`,`done`,`list` commands to increase coverage. ([\#79](https://github.com/AY2021S1-CS2113T-T09-2/tp/pull/79), [\#252](https://github.com/AY2021S1-CS2113T-T09-2/tp/pull/252))
