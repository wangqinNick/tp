...
public class TimeTableCommandParserTest {
    ...
    static final String WRONG_MOD_TIMETABLE_ADD_COMMAND_FORMAT = ADD_FORMAT + " " + MOD_CODE_2 + " "
            + DAY_OF_WEEK_2 + " " + LESSON_START_TIME_3 + " " + LESSON_END_TIME + " "
            + LESSON_TYPE + " " + REPEAT_FREQ;
    static final String WRONG_LESSON_TIME_1_TIMETABLE_ADD_COMMAND_FORMAT = ADD_FORMAT + " " + MOD_CODE_1 + " "
            + DAY_OF_WEEK_2 + " " + LESSON_START_TIME_1 + " " + LESSON_END_TIME + " " + LESSON_TYPE
            + " " + REPEAT_FREQ;
    static final String WRONG_LESSON_TIME_2_TIMETABLE_ADD_COMMAND_FORMAT = ADD_FORMAT + " " + MOD_CODE_1 + " "
            + DAY_OF_WEEK_2 + " " + LESSON_START_TIME_2 + " " + LESSON_END_TIME + " " + LESSON_TYPE
            + " " + REPEAT_FREQ;
    static final String WRONG_DAY_TIMETABLE_ADD_COMMAND_FORMAT = ADD_FORMAT + " " + MOD_CODE_1 + " "
            + DAY_OF_WEEK_1 + " " + LESSON_START_TIME_3 + " " + LESSON_END_TIME + " " + LESSON_TYPE + " "
            + REPEAT_FREQ;
    ...
    @Test
    void badTimeTableCommandFlag_InvalidMatchException_isThrown() throws InvalidMatchException {
    ...
    void bad_Module_TimeTableAddCommandFlag_ModuleNotFoundException_isThrown() {
        assertThrows(ModuleManager.ModuleNotFoundException.class,
                () -> TimeTableCommandParser.parseTimeTableCommand(WRONG_MOD_TIMETABLE_ADD_COMMAND_FORMAT));
    }
