...
public abstract class TimeTableCommand extends Command {
    ...
    public static final String TIMETABLE_LESSON_PARAMETER_USER_FORMAT  = " <module> <day> <start> <end> <type> <repeat>";
    public static final String TIMETABLE_LESSON_DELETE_USER_FORMAT  = " <week> <day> <index>";
}
